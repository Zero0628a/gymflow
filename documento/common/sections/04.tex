...
En esta sección se presentan los mockups principales de la aplicación, el flujo de navegación entre pantallas y el modelo de datos del sistema, que en conjunto definen el diseño funcional y la estructura conceptual sobre la que se construyó la implementación.
...
En conjunto, estas pantallas conforman la secuencia central del sistema y sirvieron como base para el desarrollo del producto, que luego incorporó funcionalidades adicionales como el onboarding, el calendario semanal y el registro detallado de las sesiones. Los layouts de referencia correspondientes a las interfaces principales se presentan en las Figuras \ref{fig:layout-login}, \ref{fig:layout-home}, \ref{fig:layout-ejercicios}, \ref{fig:layout-variantes}, \ref{fig:layout-crear-rutina}, \ref{fig:layout-entrenamiento} e \ref{fig:layout-historial}, con el fin de respaldar visualmente las decisiones de diseño adoptadas.
