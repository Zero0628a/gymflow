// Carga el catalogo profesional (muscles, exercises, variants, routine_templates)
// directo a Firestore usando firebase-admin. Idempotente: sobrescribe documentos
// con el mismo id, no duplica.
//
// Uso: node scripts/seed-firestore.mjs
// Requiere: scripts/serviceAccount.json (gitignoreado).
...
// =============================================================
// ROUTINE TEMPLATES (25 rutinas profesionales)
// =============================================================
function tpl(routine) {
  return {
    ...routine,
...
const routineTemplates = [
  tpl({
    ...
    level: 'beginner', goal: 'strength', daysPerWeek: 3, equipment: 'gym', split: 'full-body',
    focusLabel: 'Cuerpo completo · Fuerza',
    exerciseIds: ['sentadilla', 'press-banca', 'remo-barra', 'press-militar', 'peso-muerto'],
    sortOrder: 1,
    weeklyPlan: [
      { label: 'Dia A', focus: 'Sentadilla · Empuje', exercises: [
      ...
      { label: 'Dia B', focus: 'Sentadilla · Vertical', exercises: [
        { exerciseId: 'sentadilla', sets: 5, reps: '5', rest: '2-3 min' },
  ...
  tpl({
    ...
    level: 'beginner', goal: 'hypertrophy', daysPerWeek: 3, equipment: 'gym', split: 'full-body',
    ...
    sortOrder: 2,
    weeklyPlan: [
      { label: 'Sesion full-body', focus: 'Empuje · Traccion · Pierna', exercises: [
  ...
  tpl({
    ...
    level: 'beginner', goal: 'general', daysPerWeek: 3, equipment: 'gym', split: 'full-body',
    focusLabel: 'Cuerpo completo · General',
    exerciseIds: ['prensa', 'press-maquina', 'remo-maquina', 'elev-laterales', 'crunch'],
    sortOrder: 3,
    weeklyPlan: [
      { label: 'Sesion tipo', focus: 'Trabajo guiado', exercises: [
  ...
  tpl({
    ...
    level: 'beginner', goal: 'general', daysPerWeek: 3, equipment: 'home', split: 'home-circuit',
    focusLabel: 'Casa · General',
    exerciseIds: ['sentadilla-aire', 'flexiones', 'remo-invertido', 'plancha', 'glute-bridge'],
    sortOrder: 10,
    weeklyPlan: [
      { label: 'Circuito completo', focus: 'Peso corporal', exercises: [
  ...
  tpl({
    ...
    level: 'beginner', goal: 'endurance', daysPerWeek: 4, equipment: 'home', split: 'home-circuit',
    focusLabel: 'Casa · Resistencia',
    exerciseIds: ['sentadilla-aire', 'flexiones', 'mountain-climbers', 'plancha', 'zancadas'],
    sortOrder: 11,
    weeklyPlan: [
      { label: 'Circuito A', focus: 'Tren inferior y core', exercises: [
      ...
      { label: 'Circuito B', focus: 'Tren superior y cardio', exercises: [
  ...
  tpl({
    ...
    level: 'beginner', goal: 'strength', daysPerWeek: 3, equipment: 'home', split: 'home-circuit',
    focusLabel: 'Casa · Patrones basicos',
    exerciseIds: ['flexiones', 'remo-invertido', 'sentadilla-aire', 'plancha', 'glute-bridge'],
    sortOrder: 12,
    weeklyPlan: [
      { label: 'Sesion patron', focus: 'Fuerza con peso corporal', exercises: [
  ...
  tpl({
    ...
    level: 'beginner', goal: 'hypertrophy', daysPerWeek: 4, equipment: 'gym', split: 'upper-lower',
    ...
    sortOrder: 4,
    weeklyPlan: [
      { label: 'Upper A', focus: 'Pecho · Espalda', exercises: [
        { exerciseId: 'press-banca-mancuernas', sets: 3, reps: '10', rest: '90 s' },
      ...
      { label: 'Lower A', focus: 'Cuadriceps · Gluteos', exercises: [
      ...
      { label: 'Upper B', focus: 'Hombros · Espalda alta', exercises: [
      ...
      { label: 'Lower B', focus: 'Femorales · Core', exercises: [
  ...
  tpl({
    ...
    level: 'intermediate', goal: 'strength', daysPerWeek: 4, equipment: 'gym', split: 'upper-lower',
    focusLabel: 'Upper · Lower · Fuerza',
    exerciseIds: ['press-banca', 'remo-barra', 'sentadilla', 'peso-muerto', 'press-militar', 'dominadas'],
    sortOrder: 20,
    weeklyPlan: [
      { label: 'Upper A', focus: 'Empuje pesado', exercises: [
      ...
      { label: 'Lower A', focus: 'Sentadilla', exercises: [
      ...
      { label: 'Upper B', focus: 'Traccion pesada', exercises: [
      ...
      { label: 'Lower B', focus: 'Peso muerto', exercises: [
  ...
  tpl({
    ...
    level: 'intermediate', goal: 'hypertrophy', daysPerWeek: 4, equipment: 'gym', split: 'upper-lower',
    ...
    sortOrder: 21,
    weeklyPlan: [
      { label: 'Upper A', focus: 'Pecho · Espalda · Brazos', exercises: [
      ...
      { label: 'Lower B', focus: 'Femorales · Gluteos', exercises: [
  ...
  tpl({
    ...
    level: 'intermediate', goal: 'general', daysPerWeek: 3, equipment: 'gym', split: 'full-body',
    focusLabel: 'Full body · 3 sesiones',
    exerciseIds: ['sentadilla', 'press-banca', 'remo-barra', 'press-militar', 'curl-barra', 'plancha'],
    sortOrder: 22,
    weeklyPlan: [
      { label: 'Lunes', focus: 'Empuje', exercises: [
      ...
      { label: 'Miercoles', focus: 'Traccion', exercises: [
        { exerciseId: 'press-militar', sets: 3, reps: '8', rest: '2 min' },
        { exerciseId: 'peso-muerto-rumano', sets: 3, reps: '8', rest: '2 min' },
        { exerciseId: 'dominadas', sets: 3, reps: 'maximas', rest: '2 min' },
        { exerciseId: 'curl-barra', sets: 3, reps: '10', rest: '60 s' },
      ]},
      { label: 'Viernes', focus: 'Mix', exercises: [
  ...
  tpl({
    ...
    level: 'intermediate', goal: 'hypertrophy', daysPerWeek: 6, equipment: 'gym', split: 'ppl',
    ...
    sortOrder: 30,
    weeklyPlan: [
      { label: 'Push', focus: 'Pecho · Hombros · Triceps', exercises: [
      ...
      { label: 'Pull', focus: 'Espalda · Biceps', exercises: [
      ...
      { label: 'Legs', focus: 'Cuadriceps · Gluteos · Femorales', exercises: [
  ...
  tpl({
    ...
    level: 'advanced', goal: 'hypertrophy', daysPerWeek: 6, equipment: 'gym', split: 'ppl',
    ...
    sortOrder: 31,
    weeklyPlan: [
      { label: 'Push pesado', focus: 'Fuerza en empuje', exercises: [
      ...
      { label: 'Pull pesado', focus: 'Fuerza en traccion', exercises: [
      ...
      { label: 'Legs pesado', focus: 'Fuerza en pierna', exercises: [
      ...
      { label: 'Push volumen', focus: 'Hipertrofia empuje', exercises: [
      ...
      { label: 'Pull volumen', focus: 'Hipertrofia traccion', exercises: [
      ...
      { label: 'Legs volumen', focus: 'Hipertrofia pierna', exercises: [
  ...
  tpl({
    ...
    level: 'intermediate', goal: 'hypertrophy', daysPerWeek: 5, equipment: 'gym', split: 'bro-split',
    ...
    sortOrder: 40,
    weeklyPlan: [
      { label: 'Dia 1 · Pecho', focus: 'Pecho completo', exercises: [
      ...
      { label: 'Dia 2 · Espalda', focus: 'Anchura y grosor', exercises: [
        { exerciseId: 'dominadas', sets: 4, reps: '8-10', rest: '2 min' },
        { exerciseId: 'remo-barra', sets: 4, reps: '8', rest: '2 min' },
        { exerciseId: 'remo-sentado', sets: 3, reps: '10', rest: '90 s' },
        { exerciseId: 'jalon-polea', sets: 3, reps: '12', rest: '60 s' },
      ]},
      { label: 'Dia 3 · Hombros', focus: 'Deltoides 360', exercises: [
      ...
      { label: 'Dia 4 · Pierna', focus: 'Tren inferior completo', exercises: [
        { exerciseId: 'sentadilla', sets: 4, reps: '8', rest: '2-3 min' },
        { exerciseId: 'prensa', sets: 4, reps: '12', rest: '90 s' },
        { exerciseId: 'curl-femoral-tumbado', sets: 3, reps: '12', rest: '60 s' },
        { exerciseId: 'gemelos-de-pie', sets: 4, reps: '15', rest: '45 s' },
      ]},
      { label: 'Dia 5 · Brazos', focus: 'Biceps y triceps', exercises: [
        { exerciseId: 'curl-barra', sets: 4, reps: '10', rest: '60 s' },
        { exerciseId: 'curl-martillo', sets: 3, reps: '12', rest: '60 s' },
  ...
  tpl({
    ...
    level: 'advanced', goal: 'strength', daysPerWeek: 4, equipment: 'gym', split: 'upper-lower',
    focusLabel: 'Upper · Lower · 5x5',
    exerciseIds: ['press-banca', 'remo-pendlay', 'sentadilla', 'peso-muerto', 'press-militar', 'press-cerrado'],
    sortOrder: 50,
    weeklyPlan: [
      { label: 'Upper pesado', focus: 'Fuerza maxima', exercises: [
      ...
      { label: 'Lower pesado', focus: 'Fuerza maxima', exercises: [
      ...
      { label: 'Upper accesorio', focus: 'Hipertrofia auxiliar', exercises: [
      ...
      { label: 'Lower accesorio', focus: 'Volumen y unilateral', exercises: [
  ...
  tpl({
    ...
    level: 'advanced', goal: 'hypertrophy', daysPerWeek: 6, equipment: 'gym', split: 'bro-split',
    ...
    sortOrder: 52,
    weeklyPlan: [
      { label: 'Pecho + Espalda', focus: 'Antagonistas superiores', exercises: [
        { exerciseId: 'press-banca', sets: 4, reps: '8', rest: '2 min' },
        { exerciseId: 'dominadas', sets: 4, reps: '8-10', rest: '2 min' },
      ...
      { label: 'Hombros + Brazos', focus: 'Detalle superior', exercises: [
        { exerciseId: 'press-militar', sets: 4, reps: '8', rest: '2 min' },
        { exerciseId: 'elev-laterales', sets: 4, reps: '12-15', rest: '60 s' },
        { exerciseId: 'curl-barra', sets: 4, reps: '10', rest: '60 s' },
        { exerciseId: 'press-frances', sets: 4, reps: '10', rest: '60 s' },
      ...
      { label: 'Pierna', focus: 'Tren inferior', exercises: [
  ...
  tpl({
    ...
    level: 'intermediate', goal: 'hypertrophy', daysPerWeek: 4, equipment: 'home', split: 'upper-lower',
    ...
    sortOrder: 60,
    weeklyPlan: [
      { label: 'Upper A', focus: 'Empuje + traccion', exercises: [
      ...
      { label: 'Upper B', focus: 'Hombros + brazos', exercises: [
        { exerciseId: 'press-arnold', sets: 4, reps: '10', rest: '90 s' },
  ...
  tpl({
    ...
    level: 'intermediate', goal: 'endurance', daysPerWeek: 5, equipment: 'home', split: 'home-circuit',
    focusLabel: 'Casa · Metabolico',
    exerciseIds: ['sentadilla-aire', 'flexiones', 'mountain-climbers', 'plancha', 'zancadas', 'glute-bridge'],
    sortOrder: 61,
    weeklyPlan: [
      { label: 'Full body metabolico', focus: 'Circuito x 4 rondas', exercises: [
  ...
  tpl({
    ...
    level: 'intermediate', goal: 'endurance', daysPerWeek: 5, equipment: 'gym', split: 'upper-lower',
    ...
    sortOrder: 62,
    weeklyPlan: [
      { label: 'Upper alta rep', focus: 'Resistencia superior', exercises: [
      ...
      { label: 'Lower alta rep', focus: 'Resistencia inferior', exercises: [
      ...
      { label: 'Metabolico', focus: 'Circuito', exercises: [
      ...
      { label: 'Upper accesorio', focus: 'Detalle', exercises: [
      ...
      { label: 'Lower accesorio', focus: 'Core', exercises: [
  ...
  tpl({
    ...
    level: 'advanced', goal: 'hypertrophy', daysPerWeek: 5, equipment: 'home', split: 'ppl',
    ...
    sortOrder: 70,
    weeklyPlan: [
      { label: 'Push', focus: 'Empuje calistenia', exercises: [
      ...
      { label: 'Pull', focus: 'Traccion calistenia', exercises: [
      ...
      { label: 'Legs', focus: 'Tren inferior unilateral', exercises: [
  ...
  tpl({
    ...
    level: 'advanced', goal: 'strength', daysPerWeek: 5, equipment: 'gym', split: 'upper-lower',
  ...
  tpl({
    ...
    level: 'advanced', goal: 'general', daysPerWeek: 4, equipment: 'gym', split: 'upper-lower',
  ...
  tpl({
    ...
    sortOrder: 80,
    weeklyPlan: [
      { label: 'Lower glute A', focus: 'Gluteos pesado', exercises: [
      ...
      { label: 'Upper corto', focus: 'Mantenimiento superior', exercises: [
        { exerciseId: 'press-banca-mancuernas', sets: 3, reps: '10', rest: '90 s' },
        { exerciseId: 'remo-mancuerna', sets: 3, reps: '10', rest: '90 s' },
        { exerciseId: 'elev-laterales', sets: 3, reps: '15', rest: '60 s' },
      ]},
      { label: 'Lower glute B', focus: 'Femoral y unilateral', exercises: [
        { exerciseId: 'peso-muerto-rumano', sets: 4, reps: '10', rest: '2 min' },
        { exerciseId: 'sentadilla-bulgara', sets: 4, reps: '10 por pierna', rest: '90 s' },
        { exerciseId: 'curl-femoral-sentado', sets: 4, reps: '12', rest: '60 s' },
        { exerciseId: 'step-up', sets: 3, reps: '12 por pierna', rest: '60 s' },
      ]},
      { label: 'Upper corto 2', focus: 'Pull dominante', exercises: [
...
// SEED
// =============================================================
async function commitInChunks(items, collectionName, transform) {
  // Firestore batches max 500 ops. Splitteo a 400 por seguridad.
  const chunkSize = 400;
  for (let i = 0; i < items.length; i += chunkSize) {
    const slice = items.slice(i, i + chunkSize);
    const batch = db.batch();
    for (const item of slice) {
      const { id, ...payload } = transform(item);
      batch.set(db.collection(collectionName).doc(id), payload);
    }
    await batch.commit();
    console.log(`  ✓ ${collectionName}: ${i + slice.length}/${items.length}`);
  }
}

async function main() {
  console.log('Seeding Firestore (project: gymflow-7d764)...\n');

  console.log('→ muscles');
  await commitInChunks(muscles, 'muscles', (m) => ({
    id: m.id,
    name: m.name,
    icon: m.icon,
    color: m.color,
  ...
  await commitInChunks(exercises, 'exercises', (e) => ({
    id: e.id,
    muscleId: e.muscleId,
    name: e.name,
  ...
  await commitInChunks(variants, 'variants', (v) => ({
    id: v.id,
  ...
  console.log('→ routine_templates');
  await commitInChunks(routineTemplates, 'routine_templates', (r) => r);
